  ...
  return (
    <div className="space-y-6">
      <div className="bg-muted px-4 py-3 rounded-lg border border-border">
        ...
        <p className="font-semibold text-foreground text-lg">Network Architecture</p>
      </div>

      <div className="flex items-center justify-center min-h-[365px] gap-8">
        <div className="flex flex-col items-center">
          <div className="text-lg font-semibold mb-4 text-foreground">Client</div>
          <Card className="w-48 h-32 bg-blue-200 border-2 border-blue-500 flex items-center justify-center">
            <div className="text-center">
              <div className="font-semibold text-foreground">Frontend</div>
              <div className="font-semibold text-foreground">Application</div>
            </div>
          </Card>
        </div>
        ...
        <div className="flex flex-col items-center">
          <Card className="w-32 h-20 bg-purple-200 border-2 border-purple-400 rounded-full flex items-center justify-center mb-4">
        ...
        <div className="flex flex-col items-center">
          <div className="text-lg font-semibold mb-4 text-foreground">Server</div>
          <Card className="w-48 h-32 bg-green-200 border-2 border-green-500 flex items-center justify-center">
            <div className="text-center">
